function [bestSolution, bestFitness, iteration]=bsafdbpopartandu20(fhd, dimension, maxIteration, fNumber)
...
fe=0;
    while fe<maxIteration
        ...
        for i=1:popsize
            if rand < 0.2
                if FdbPopArtnDu(pop, fitnesspop, i, offsprings(i,:), fitnessoffsprings(i), maxIteration, fe)
